...
def parse_args():
    parser = argparse.ArgumentParser(description="Explore the latent space interactively")

    parser.add_argument("--run", type=str, default=DEFAULTS["run"],
    ...
    parser.add_argument("--components", type=int, default=DEFAULTS["components"],
